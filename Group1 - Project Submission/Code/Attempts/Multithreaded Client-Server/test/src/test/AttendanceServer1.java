...
import java.sql.*; 
public class AttendanceServer1 {
    ...
    public AttendanceServer1() throws ClassNotFoundException {Class.forName("com.mysql.cj.jdbc.Driver");}
    ...
    private String getClasses(String username, String password) {
        ...
        try {
        	...
        	while(rs0.next()) {
        		id.append(rs0.getString(1));
        	}
	        String query = "SELECT classnumber " + "FROM Class " + "WHERE ID= " + "'" + id.toString() + "'";
