	...
	<div id="ShowHideButton">
		...
		<div id="UpdateTableButton"
			...
			<button onclick="myFunctionSortButton()" class="button">Sort
				By...</button>
			<div id="SortButton" style="display: none; margin: 20px 0px 0px; position: fixed;">
		...
		<div style="float: right; margin-right: 540px; position: :fixed;">
			<h2 align="center">
				<font><strong>EECE 351 Class</strong></font>
			</h2>
